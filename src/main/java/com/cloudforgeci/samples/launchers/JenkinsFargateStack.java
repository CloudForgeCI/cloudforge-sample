...
public class JenkinsFargateStack extends Stack {
    ...
    public JenkinsFargateStack(final Construct scope, final String id, final StackProps props,
        ...
        try {
            System.out.println("JenkinsFargateStack: About to call JenkinsFactory.createFargate()");
            JenkinsFactory.createFargate(this, id, cfc, security, iamProfile);
            System.out.println("JenkinsFargateStack: JenkinsFactory.createFargate() completed successfully");
        } catch (Exception e) {
            System.out.println("JenkinsFargateStack: Exception in JenkinsFactory.createFargate(): " + e.getMessage());
            e.printStackTrace();
            throw e;
        }
    }
